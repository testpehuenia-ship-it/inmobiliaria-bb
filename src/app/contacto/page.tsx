...
export default function ContactoPage() {
  return (
    <div className="contact-page-container" style={{ maxWidth: '1200px', margin: '0 auto', padding: '60px 20px' }}>
      <div className="contact-header" style={{ textAlign: 'center', marginBottom: '50px' }}>
        <h1 style={{ fontSize: '2.5rem', color: '#2b6e4f', marginBottom: '15px' }}>¿En qué podemos ayudarte?</h1>
        <p style={{ fontSize: '1.2rem', color: '#666' }}>Estamos aquí para asesorarte en cada paso de tu camino inmobiliario.</p>
      </div>

      <div className="forms-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(350px, 1fr))', gap: '40px', alignItems: 'start' }}>
